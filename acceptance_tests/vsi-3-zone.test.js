...
tfx.plan("tfx Generated Plan", () => {
  ...
  tfx.module(
    "Security Groups Workload Vsi",
    'module.security_groups["workload-vsi"]',
    tfx.resource(
      "Security Group Workload Vsi Sg",
      'ibm_is_security_group.security_group["workload-vsi-sg"]',
      {
        name: "at-workload-vsi-sg",
        tags: ["icse", "landing-zone"],
      }
    )
  );
  ...
  tfx.module(
    "Security Group Rules Workload Vsi Sg",
    'module.security_groups["workload-vsi"].module.security_group_rules["workload-vsi-sg"]',
    tfx.resource(
      "Rule Workload Vsi Sg Allow In 1",
      'ibm_is_security_group_rule.rule["workload-vsi-sg-allow-in-1"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Rule Workload Vsi Sg Allow In 2",
      'ibm_is_security_group_rule.rule["workload-vsi-sg-allow-in-2"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Rule Workload Vsi Sg Allow Out 1",
      'ibm_is_security_group_rule.rule["workload-vsi-sg-allow-out-1"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
  ...
  tfx.module(
    "Vsi Deployment Workload Vsi",
    'module.vsi_deployment["workload-vsi"]',
    tfx.resource("Image 0", "data.ibm_is_image.image[0]", {
      name: "ibm-ubuntu-18-04-6-minimal-amd64-3",
    })
  );
  ...
  tfx.module(
    "Vsi Workload Vsi Vsi 1",
    'module.vsi_deployment["workload-vsi"].module.vsi["workload-vsi-vsi-1"]',
    tfx.resource("Vsi", "ibm_is_instance.vsi", {
      boot_volume: [
        {
          snapshot: null,
  ...
  tfx.module(
    "Vsi Workload Vsi Vsi 3",
    'module.vsi_deployment["workload-vsi"].module.vsi["workload-vsi-vsi-3"]',
    tfx.resource("Vsi", "ibm_is_instance.vsi", {
      boot_volume: [
        {
          snapshot: null,
  ...
  tfx.module(
    "Vsi Workload Vsi Vsi 2",
    'module.vsi_deployment["workload-vsi"].module.vsi["workload-vsi-vsi-2"]',
    tfx.resource("Vsi", "ibm_is_instance.vsi", {
      boot_volume: [
        {
          snapshot: null,
