...
tfx.plan("tfx Generated Plan", () => {
  /**
   * Root module, encryption keys, resource groups, ssh key
   */
  tfx.module(
    "Root Module",
    "root_module",
    tfx.resource("Template SSH Key", "ibm_is_ssh_key.ssh_key[0]", {
      name: "at-ssh-key",
      public_key: "test-value",
    }),
    tfx.resource("Cluster Encryption Key", "ibm_kms_key.cluster_key[0]", {
  ...
  tfx.module(
    ...
    tfx.resource(
      "Server Protect KMS Auth Policy",
    ...
    tfx.resource("Key Protect", "ibm_resource_instance.kms[0]", {
      location: "us-south",
      name: "at-kms",
      plan: "tiered-pricing",
      service: "kms",
  ...
  tfx.module(
    ...
    tfx.resource(
      "Transit Gateway Management Connection",
    ...
    tfx.resource(
      "Transit Gateway Workload Connection",
  ...
  // Management Public Gateway
  tfx.module(
    "Management Public Gateways",
  ...
  tfx.module(
    ...
    tfx.resource("Management VPE ACL", 'ibm_is_network_acl.acl["vpe-acl"]', {
    ...
    tfx.resource("Management VPN ACL", 'ibm_is_network_acl.acl["vpn-acl"]', {
    ...
    tfx.resource("Management VSI ACL", 'ibm_is_network_acl.acl["vsi-acl"]', {
